const NursingFacultyCalendarPage = () => {
  const guzYariyili = [
    { event: 'Eğitim-Öğretim Başlangıcı', date: '22 Eylül 2025' },
    { event: 'Eğitim-Öğretim Bitişi (Uygulamalı Dersler)', date: '16 Ocak 2026' },
    { event: 'Eğitim-Öğretim Bitişi (İşletmede Mesleki Eğitim Dersi)', date: '23 Ocak 2026' },
    { event: 'Yarıyıl/Yıl İçi Etkinlikleri (Ara Sınav) Başlangıç Tarihi', date: '24 Kasım 2025' },
    { event: 'Yarıyıl/Yıl İçi Etkinlikleri (Ara Sınav) Bitiş Tarihi', date: '29 Kasım 2025' },
    { event: 'Yarıyıl/Yıl Sonu Bitirme Sınavları Başlangıcı (Uygulamalı Dersler)', date: '19 Ocak 2026' },
    { event: 'Yarıyıl/Yıl Sonu Bitirme Sınavları Başlangıcı (İşletmede Mesleki Eğitim)', date: '26 Ocak 2026' },
    ...
    { event: 'Yarıyıl/Yıl Sonu Bütünleme Sınavları Bitiş Tarihi', date: '7 Şubat 2026' },
  ]

  const baharYariyili = [
    { event: 'Eğitim-Öğretim Başlangıcı', date: '23 Şubat 2026' },
    { event: 'Eğitim-Öğretim Bitişi (Uygulamalı Dersler)', date: '26 Haziran 2026' },
    { event: 'Eğitim-Öğretim Bitişi (İşletmede Mesleki Eğitim)', date: '3 Temmuz 2026' },
    { event: 'Yarıyıl/Yıl İçi Etkinlikleri (Ara Sınav) Başlangıç Tarihi', date: '20 Nisan 2026' },
    { event: 'Yarıyıl/Yıl İçi Etkinlikleri (Ara Sınav) Bitiş Tarihi', date: '25 Nisan 2026' },
    { event: 'Yarıyıl/Yıl Sonu Bitirme Sınavları Başlangıcı (Uygulamalı Dersler)', date: '26 Haziran 2026' },
    { event: 'Yarıyıl/Yıl Sonu Bitirme Sınavları Başlangıcı (İşletmede Mesleki Eğitim)', date: '29 Haziran 2026' },
    { event: 'Yarıyıl/Yıl Sonu Bitirme Sınavları Bitiş Tarihi', date: '6 Temmuz 2026' },
  ...
  const kayitYenileme = [
    {
      ...
      ciftAnadalBaslangic: '29 Eylül 2025',
      ciftAnadalBitis: '3 Ekim 2025',
    },
    {
      ...
      ciftAnadalBaslangic: '2 Mart 2026',
      ciftAnadalBitis: '6 Mart 2026',
    },
  ]
  ...
  const yabanciDilHazirlik = [
    { event: 'Yabancı Dil Hazırlık Eğitimi Başlangıcı (Güz)', date: '29 Eylül 2025' },
    { event: 'Yabancı Dil Hazırlık Eğitimi Bitişi (Güz)', date: '9 Ocak 2026' },
    { event: 'Güz Dönemi Bitirme Sınavı (Yazılı)', date: '12 Ocak 2026' },
    { event: 'Güz Dönemi Bitirme Sınavı (Konuşma)', date: '13-14 Ocak 2026' },
    { event: 'Bütünleme Sınavı (Güz)', date: '20 Ocak 2026' },
    { event: 'Ara Dönem Yeterlilik Sınavı', date: '23 Ocak 2026' },
    { event: 'Yabancı Dil Hazırlık Eğitimi Başlangıcı (Bahar)', date: '16 Şubat 2026' },
    { event: 'Yabancı Dil Hazırlık Eğitimi Bitişi (Bahar)', date: '5 Haziran 2026' },
    { event: 'Bahar Dönemi Bitirme Sınavı (Yazılı)', date: '8 Haziran 2026' },
    { event: 'Bahar Dönemi Bitirme Sınavı (Konuşma)', date: '9-10 Haziran 2026' },
    { event: 'Bütünleme Sınavı (Bahar)', date: '16 Haziran 2026' },
    { event: 'Yıl Sonu Yeterlilik Sınavı', date: '19 Haziran 2026' },
  ]
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900 mb-2">
            2025-2026 Eğitim-Öğretim Yılı Florence Nightingale Hemşirelik Fakültesi Akademik Takvimi
          </h1>
        ...
        <div className="space-y-8">
                ...
                <div key={index} className="border border-gray-200 rounded-lg p-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                    ...
                    <div className="flex justify-between md:col-span-2">
                      <span className="text-gray-600">Çift Anadal/Yandal Ders Alma:</span>
                      <span className="font-medium">
                        {item.ciftAnadalBaslangic} - {item.ciftAnadalBitis}
                      </span>
                    </div>
                  </div>
                </div>
          ...
          {/* Bölüm 5: Yabancı Dil Hazırlık Eğitimi */}
          <div className="bg-white rounded-lg shadow-md p-6">
            <h2 className="text-xl font-bold text-gray-900 mb-6 pb-3 border-b border-gray-200">
              YABANCI DİLLER YÜKSEKOKULU - YABANCI DİL HAZIRLIK EĞİTİMİ
            </h2>
            {renderTable(yabanciDilHazirlik)}
          </div>

          {/* Bölüm 6: Çift Anadal ve Yandal */}
          <div className="bg-white rounded-lg shadow-md p-6">
            <h2 className="text-xl font-bold text-gray-900 mb-6 pb-3 border-b border-gray-200">
        ...
        <div className="mt-8 bg-blue-50 border border-blue-200 rounded-lg p-6">
          ...
          <ul className="space-y-2 text-sm text-gray-700">
            ...
            <li>
              • Uygulamalı dersler ve işletmede mesleki eğitim dersleri için farklı bitiş tarihleri
              uygulanmaktadır.
            </li>
          </ul>
        </div>
...
export default NursingFacultyCalendarPage
